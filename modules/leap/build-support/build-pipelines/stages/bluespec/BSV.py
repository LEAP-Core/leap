    ...
    def setup_tree_build(self, moduleList, topo):
        ...
        if(not self.firstPassLIGraph is None):
            ...
            for module in sorted(liGraph.graph.nodes(), key=lambda module: module.name):
                ...
                wrapper_command = self.compile_bo_bsc_base([wrapper_bo_path], get_build_path(moduleList, moduleList.topModule), vdir=importVDir) + ' ' + wrapper_path
        ...
        platform_synth_command = self.compile_bo_bsc_base([platform_synth_bo_path + '.bo'], get_build_path(moduleList, moduleList.topModule), vdir=importVDir) + ' ' + platform_synth
